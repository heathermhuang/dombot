/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=hosted/wrangler.gateway.jsonc --env-interface=HostedEnv hosted-configuration.d.ts` (hash: 2510b91afd364b0efde863eebd6ed351)
// Runtime types generated with workerd@1.20260903.1 2026-09-09 nodejs_compat
interface __BaseEnv_HostedEnv {
	CONTROL_DB: D1Database;
	WORKSPACES: "[]";
	WORKSPACE_0: Fetcher /* domains-staging-tenant-0 */;
	WORKSPACE_1: Fetcher /* domains-staging-tenant-1 */;
	WORKSPACE_2: Fetcher /* domains-staging-tenant-2 */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/hosted/gateway");
	}
	interface Env extends __BaseEnv_HostedEnv {}
}
interface HostedEnv extends __BaseEnv_HostedEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKSPACES">> {}
}
